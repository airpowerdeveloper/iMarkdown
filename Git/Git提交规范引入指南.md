Git 每次提交代码，都要写 Commit message（提交说明）。经常在别人的代码提交仓库里看到类似的**「单词」**：
...
每个公司可能都会根据自己的实际情况定一些提交规范。尤其是在一些大型开源项目中，commit message 是非常重要的。可以参考https://www.conventionalcommits.org/en/v1.0.0/
